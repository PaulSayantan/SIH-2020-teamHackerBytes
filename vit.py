...
with open('vit.json') as json_data:
...
def sendPostRequest(reqUrl, apiKey, secretKey, useType, person_name,person_age, phoneNo, senderId, textMessage):
  ...
  'usetype':'stage',
  'phone': phoneNo,
  'message':"{} Age: {}, According to your latest medical report, you have been deprived of essential vitamins in your diet. Please visit your nearest Poshan-Abhiyaan Camp as soon as possible.".format(person_name, person_age),
  'senderid': 'SMSIND'
  }
